		 ...
		 try(BufferedReader reader = new BufferedReader(new FileReader(fileName)))
		 {
			 while((line = reader.readLine())!= null)
			 {
				 ...
				 if(entries[0].equals(SHAMPOO))
				 {
					 ...
					 Shampoo shampooObject = new Shampoo(name, price, description, ingredients, size, hairType, hairGrowth);
				 ...
				 else if (entries[0].equals(MOISTURIZER))
				 {
						 ...
						 Moisturizer moisturizerObject = new Moisturizer(name, price, description, ingredients, size, skinType, acnePreventor);
